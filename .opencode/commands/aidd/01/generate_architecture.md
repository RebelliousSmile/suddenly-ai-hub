...
```markdown
@.opencode/commands/aidd/01/generate_agent.md
```

```markdown
@.opencode/commands/aidd/01/generate_skill.md
```
...
```markdown
@.opencode/rules/04-tooling/ide-mapping.md
```

### Mermaid standards

```markdown
@.opencode/rules/01-standards/1-mermaid.md
```

### Command generator

```markdown
@.opencode/commands/aidd/01/generate_command.md
```

### Command structure standards

```markdown
@.opencode/rules/01-standards/1-command-structure.md
```
