...
1. Brainstorm implementation approach: .opencode/commands/aidd/02/brainstorm.md
2. Generate technical plan: .opencode/commands/aidd/03/plan.md
3. Implement changes: .opencode/commands/aidd/04/implement.md
4. Run tests: Execute test suite if applicable
5. Commit changes: .opencode/commands/aidd/08/commit.md
6. Code review: .opencode/commands/aidd/05/review_code.md
7. Functional review: .opencode/commands/aidd/05/review_functional.md
8. Create PR: .opencode/commands/aidd/08/create_request.md
