...
- Extract components from image: `@.opencode/commands/aidd/03/image_extract_details.md`

#### Instruction steps

```text
@.opencode/commands/aidd/04/implement_from_design.md
```
...
```text
@.opencode/commands/aidd/04/assert_frontend.md
```
...
```text
@.opencode/commands/aidd/06/test_journey.md
```
