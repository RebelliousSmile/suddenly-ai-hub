---
name: rule-01-command-structure
description: Standards for naming, organizing, and writing command files. Apply when creating or editing any command file.
category: rules
---

# Rule: 01 Command Structure

## Description

This rule defines standards for naming, organizing, and writing command files. apply when creating or editing any command file.. It applies to the project context.
