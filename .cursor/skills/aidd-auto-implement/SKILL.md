...
1. Brainstorm implementation approach: .cursor/commands/aidd/02/brainstorm.md
2. Generate technical plan: .cursor/commands/aidd/03/plan.md
3. Implement changes: .cursor/commands/aidd/04/implement.md
4. Run tests: Execute test suite if applicable
5. Commit changes: .cursor/commands/aidd/08/commit.md
6. Code review: .cursor/commands/aidd/05/review_code.md
7. Functional review: .cursor/commands/aidd/05/review_functional.md
8. Create PR: .cursor/commands/aidd/08/create_request.md
