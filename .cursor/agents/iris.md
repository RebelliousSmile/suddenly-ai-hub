...
- Extract components from image: `@.cursor/commands/aidd/03/image_extract_details.md`

#### Instruction steps

```text
@.cursor/commands/aidd/04/implement_from_design.md
```
...
```text
@.cursor/commands/aidd/04/assert_frontend.md
```
...
```text
@.cursor/commands/aidd/06/test_journey.md
```
