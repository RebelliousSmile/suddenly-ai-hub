...
```markdown
@.cursor/commands/aidd/01/generate_agent.md
```

```markdown
@.cursor/commands/aidd/01/generate_skill.md
```
...
```markdown
@.cursor/rules/04-tooling/ide-mapping.mdc
```

### Mermaid standards

```markdown
@.cursor/rules/01-standards/1-mermaid.mdc
```

### Command generator

```markdown
@.cursor/commands/aidd/01/generate_command.md
```

### Command structure standards

```markdown
@.cursor/rules/01-standards/1-command-structure.mdc
```
